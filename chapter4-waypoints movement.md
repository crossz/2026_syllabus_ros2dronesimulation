...
TurtleBot3 硬件/仿真
       ↓
  SLAM 建图 (Cartographer / SLAM Toolbox)
       ↓
  Nav2 导航栈 (路径规划 + 避障)
       ↓
...
echo "export TURTLEBOT3_MODEL=burger" >> ~/.bashrc  # burger / waffle / waffle_pi
source ~/.bashrc
```
...
> 📌 参考：[ROBOTIS TurtleBot3 Navigation 官方文档](https://emanual.robotis.com/docs/en/platform/turtlebot3/navigation/)
